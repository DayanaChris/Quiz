          ...
          <!-- BEGIN LOGO -->
            ...
            <form class="login-form" action="<?php echo base_url()?>auth/login" accept-charset="utf-8" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" value="" id="password"/> </div>
